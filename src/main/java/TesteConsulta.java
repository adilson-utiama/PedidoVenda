...
public class TesteConsulta {
	...
	public static void main(String[] args) {
		...
		Map<Date, BigDecimal> mapa = valoreTotaisPorData(15, usuario, session);
	...
	public static Map<Date, BigDecimal> valoreTotaisPorData(Integer numeroDeDias, Usuario criadoPor,
				Session session){
